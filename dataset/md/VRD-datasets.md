...
| ------ | ------ | ------ |
| **Fixed** | **Category I:** passport ,national ID card, train ticket, business license, fixed-format taxi invoice | **Category II:** business email ,national housing contract |
| **Variable** | **Category III:** medical invoice, paper head, bank card,free-format invoice, purchase receipt, business card, purchase orders | **Category IV:** personal resume,financial report,newspaper,free-format sales contract |
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| I |Train ticket  | 271.44k | 30.16k|400 |  5 | -  | {entity} | Syn|
| I |Passport  | 88.2k |9.8k|2k |  5 | -  |  {entity} | Syn|
| I |**Taxi invoice** | 4000 | -|1000  |  9 | 136240 |  {pos, text, entity}| Real |
| II |**Business email** | 1146 | - |499 | 16 | 35346 |  {pos, text, entity}| Real|
| III |SROIE  | 626 | - |347 |  4 |  52451 | {pos, text, entity}|Real|
| III |Business card  | 178.2k |19.8k |2k |  9 | -  |  {entity}|Syn|
| III |FUNSD  | 149 | -|50 |  4 | 31,485 |   {pos, text, entity}|Real|
| III |CORD  | 800 | 100|100 |  30 | - |  {pos, text, entity}|Real|
| III |EPHOIE  | 1183 | - |311 |  12 | 15,771 |   {pos, text, entity}| Real|
| III |WildReceipt  |1267  | - | 472| 26  | 69,000 |   {pos, text, entity}| Real|
| IV |Kleister-NDA | 254 | 83|203 |  4 | - |{pos, text, entity}| Real|
| IV|**Resume** | 1045 | -|482 |  11 | 82800 |   {pos, text, entity}| Real |
